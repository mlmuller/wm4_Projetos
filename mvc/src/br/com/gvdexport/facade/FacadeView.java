...
//-----------------------------------------------------    
	...
	public void visaoConstrucao() {
		if(informaConstrucao.isEmpty()) {
			Messages.addGlobalInfo("Informe Construção para pesquisa !");
			return;
		}
	...
	public void visaoForma() {
		if(informaForma.isEmpty()) {
			Messages.addGlobalInfo("Informe Forma para pesquisa !");
			return;
		}
